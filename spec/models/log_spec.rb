...
RSpec.describe Log, type: :model do
  ...
  describe ".date_range_active_users_total" do
    ...
    let!(:log1) { create(:log, user: user1, booking: booking1, activity: activity1, type: "預訂送出", created_at: 2.days.ago) }
    ...
    let!(:log2) { create(:log, user: user2, booking: booking2, activity: activity2, type: "預訂送出", created_at: 10.days.ago) }
  ...
  describe ".booking_duration" do
    ...
    before do
      preview_log = create(:log, type: 'browse_activity_show', created_at: 2.days.ago)
      form_input_log = create(:log, type: 'email_field_changed', created_at: 2.days.ago + 1.hours)
      submit_log = create(:log, type: 'submitted', created_at: 2.days.ago + 3.hours)
